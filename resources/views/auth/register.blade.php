...
@section('content')
    <form class="form" action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-3 f-email">
            ...
            <label for="InputEmail" class="form-label form-label-email">Fullname</label>
        </div>
        <div class="mb-3 f-email">
        ...
        <div class="mb-3 f-password">
            <input type="password" name="password_confirmation"
                class="form-control form-password @error('password') is-invalid @enderror" id="InputPasswordConfirmation"
                required>
